...
@router.post("/get")
def get_diagnosis(payload: dict[str, Any] = Body(...)) -> dict[str, Any]:
    ...
    try:
        ...
        raise api_error(500, "internal_engine_error", str(exc)) from exc
    return build_attempt_response(orchestrated, include_debug=request.options.include_debug, include_node=False)
